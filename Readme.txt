...
BGL Log Analysis with Hadoop MapReduce Pattern :
	...
	1)Start the implementation of code, after saving the .py in your path of terminal makes sure you are giving 'chmod +x 6.py' execution permission for the file.
	2)Run below command to get the output :
		time python 6.py -r hadoop hdfs:///user/hduser/BGL.log
